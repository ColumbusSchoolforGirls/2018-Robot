...
public class Turn extends Command {
    ...
    protected void initialize() {
    	...
    	Drivetrain.setSpeed(ControlMode.PercentOutput, -angleOutput, angleOutput); //TODO: Figure out which is positive and which is negative
    }

        protected boolean isFinished() {
    	return(Drivetrain.getLeftError() <= Math.abs(Global.ENCODER_TOLERANCE) && Drivetrain.getRightError() <= Math.abs(Global.ENCODER_TOLERANCE));	
    }
